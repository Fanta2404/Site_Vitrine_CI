...
export default function Departements() {
    return (
        <>
            <section style={{ position: 'relative', height: 400, overflow: 'hidden', display: 'flex', alignItems: 'center', background: 'linear-gradient(135deg, var(--bleu-fonce) 0%, var(--bleu) 100%)' }}>
                <div style={{ position: 'absolute', inset: 0, background: 'radial-gradient(circle at 50% 50%, rgba(212, 160, 23, 0.15) 0%, transparent 80%)' }} />
                    ...
                    <div className="container">
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '5rem', alignItems: 'center' }}>
                            ...
                            <div>
                                ...
                                <h2 style={{ fontSize: '2.5rem', color: d.couleur, marginBottom: '1.5rem' }}>{d.nom}</h2>
                                ...
                                <div style={{ marginTop: '2.5rem' }}>
                                    <Link to={d.code === 'NTIC' ? '/departements/ntic' : '/departements/dlsi'} className="btn btn-outline" style={{ padding: '0.8rem 2rem', color: d.couleur, borderColor: d.couleur }}>
                                        En savoir plus →
                                    </Link>
                                </div>
                            </div>
